...
async function initDatabase() {
  await pool.query(`
    ...
    -- AI-powered question enrichment fields
    ALTER TABLE question_bank ADD COLUMN IF NOT EXISTS exam_type TEXT;
    ALTER TABLE question_bank ADD COLUMN IF NOT EXISTS exam_year INTEGER;
    ALTER TABLE question_bank ADD COLUMN IF NOT EXISTS option_wise_explanation TEXT;
